...
export default function Navbar() {
  ...
  return (
    <motion.nav 
      ...
      className="fixed top-4 left-0 right-0 mx-auto w-11/12 max-w-4xl z-50">
      ...
      {open && isMobile && (
        <motion.div 
          ...
          className="absolute top-20 left-0 right-0 mx-auto w-full">
          <div className="p-4 bg-black/40 backdrop-blur-lg glass-panel rounded-lg border border-white/20 shadow-[0_0_50px_rgba(255,255,255,0.2)]">
            <nav className="flex flex-col space-y-2">
              <Link href="/" onClick={() => setOpen(false)} className="text-zinc-300 px-3 py-2 rounded-md hover:bg-white/5 transition-colors">Home</Link>
              <Link href="/epitech" onClick={() => setOpen(false)} className="text-zinc-300 px-3 py-2 rounded-md hover:bg-white/5 transition-colors">Epitech</Link>
              <Link href="/associations" onClick={() => setOpen(false)} className="text-zinc-300 px-3 py-2 rounded-md hover:bg-white/5 transition-colors">Associations</Link>
              <Link href="/skills" onClick={() => setOpen(false)} className="text-zinc-300 px-3 py-2 rounded-md hover:bg-white/5 transition-colors">Skills</Link>
              <Link href="/events" onClick={() => setOpen(false)} className="text-zinc-300 px-3 py-2 rounded-md hover:bg-white/5 transition-colors">Events</Link>
